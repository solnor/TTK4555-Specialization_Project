...
% Electric constants
R_m   = 19.00e-3; % [mOhm] - Stator resistance
% R_m   = 0.04068; % [mOhm] - Stator resistance
L_m   = 8.97e-6;  % [uH]   - Stator self inductance
% L_m   = 40.43e-6;  % [uH]   - Stator self inductance
psi_m = 4.88e-3;  % [mWb]  - Magnetic flux linkage between rotor magnets/stator coils
